  ...
  require('lazy').setup({
    ...
    },
    {
      ...
      config = function()
        ...
        -- local auto_completion_lsp_server = require 'custom.auto-completion-lsp-server'
        -- trace
        ...
        if not lspconfigs.auto_completion_lsp_server then
          lspconfigs.auto_completion_lsp_server = {
            default_config = {
        ...
        -- lspconfig['auto_completion_lsp_server'] = {
        --   default_config = custom_server,
        -- }
        lspconfig['auto_completion_lsp_server'].setup {}
