...
local bundles =
  { vim.fn.glob('C:/Users/rohit.kamu/nvim-related-data/java-debug/com.microsoft.java.debug.plugin/target/com.microsoft.java.debug.plugin-0.53.1.jar', true) }
vim.list_extend(bundles, vim.split(vim.fn.glob('C:/Users/rohit.kamu/vscjava.vscode-java-debug-0.58.1/vscode-java-test/server/*.jar', true), '\n'))

local project_name = vim.fn.fnamemodify(vim.fn.getcwd(), ':p:h:t')

local workspace_dir = 'C:/Users/rohit.kamu/nvim-related-data/eclipse.jdt.ls/org.eclipse.jdt.ls.product/target/repository/' .. project_name
...
local config = {
  ...
  cmd = {
    ...
    -- 💀
    '-jar',
    'C:/Users/rohit.kamu/nvim-related-data/eclipse.jdt.ls/org.eclipse.jdt.ls.product/target/repository/plugins/org.eclipse.equinox.launcher_1.6.1000.v20250131-0606.jar',
    -- ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^                                       ^^^^^^^^^^^^^^
    ...
    -- 💀
    '-configuration',
    'C:/Users/rohit.kamu/nvim-related-data/eclipse.jdt.ls/org.eclipse.jdt.ls.product/target/repository/config_win',
    -- ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^        ^^^^^^
